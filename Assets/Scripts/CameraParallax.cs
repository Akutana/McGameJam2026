...
public class CameraParallax : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        GameManager.OnShopTurnStarted += ChangeTargetPosition;
    ...
    void HandleShopTransition()
    {
        ...
        if (isMoving)
        {
            ...
            if (Vector3.Distance(transform.position, shopPos) < 0.01f)
            {
                isMoving = false;
    ...
    { 
        ...
        targetPosition = targetPosition == shopPos ? originalPos : shopPos;
        targetRotation = Camera.main.transform.rotation * Quaternion.Euler(0f, 180f, 0f);
    }
}
